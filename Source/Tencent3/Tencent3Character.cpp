...
void ATencent3Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Fire",IE_Pressed,this,&ATencent3Character::Fire);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ATencent3Character::OnResetVR);
}


void ATencent3Character::OnResetVR()
{
	// If Tencent3 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Tencent3.Build.cs is not automatically propagated
